...
<div class="products">
   ...
   <?php
      $select_product = mysqli_query($conn, "SELECT * FROM `products8`") or die('query failed');
   ...
   <table>
      ...
      ?>
         <tr>
            ...
            <td><a href="cart8.php?remove=<?php echo $fetch_cart['id']; ?>" class="delete-btn" onclick="return confirm('remove item from cart?');">remove</a></td>
         </tr>
      <?php
      ...
      <tr class="table-bottom">
         ...
         <td><a href="cart8.php?delete_all" onclick="return confirm('delete all from cart?');" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>">delete all</a></td>
      </tr>
   </tbody>
   </table>
