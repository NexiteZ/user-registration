  ...
  <body class="text-center">
      ...
      <div class="container">
            <form method="post" class="form-signin">
			  ...
			  <br></br>
			  <a href="logincomment.php" class="mt-5 mb-3 text-muted">Go to Comments Login</a>
            </form>
          </div>
		  
		<div class="btn3" id="btn3">
	<a href="personal.php">Go to Front Page</a>
	</div>
	
	<div class="btn4" id="btn4">
	<a href="login3.php">Go to Website Login</a>
	</div>
