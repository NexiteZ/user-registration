                    ...
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                ...
                                <a href="Bea Dress.php" class="dropdown-item">Bea Dress</a>
                            </div>
                        </div>
                        <a href="pants.php" class="nav-item nav-link">Pants</a>
                        <a href="short.php" class="nav-item nav-link">Shorts</a>
                        <a href="terno.php" class="nav-item nav-link">Terno</a>
                        <a href="tops.php" class="nav-item nav-link">Tops</a>
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
