    ...
    <!-- Page Header End -->
	 <main class="container">
      ...
      <div class="left-column">
        <img data-image="creampants" src="pt5.jpg" alt="">
        <img data-image="blackpants" src="pt2.jpg" alt="">
        <img data-image="brownpants" class="active" src="pt1.jpg" alt="">
      </div>
      ...
      <div class="right-column">
        ...
        <div class="product-configuration">
          ...
          <div class="product-color">
            ...
            <div class="color-choose">
              <div>
                <input data-image="brownpants" type="radio" id="brownpants" name="color" value="brownpants" checked>
                <label for="brownpants"><span></span></label>
              </div>
              <div>
                <input data-image="blackpants" type="radio" id="blackpants" name="color" value="blackpants">
                <label for="blackpants"><span></span></label>
              </div>
              <div>
                <input data-image="creampants" type="radio" id="creampants" name="color" value="creampants">
                <label for="creampants"><span></span></label>
              </div>
            </div>
        ...
        <div class="product-price">
          <span>₱100</span>
<a href="" onclick='myFunction()' class="cart-btn" id="myLink">Add to Cart</a>

<script>
    function myFunction() {
   
        if(document.getElementById('brownpants').checked) {
            document.getElementById('myLink').href = "brownpants.php";
        }
		if(document.getElementById('blackpants').checked) {
            document.getElementById('myLink').href = "blackpants.php";
        }
		if(document.getElementById('creampants').checked) {
            document.getElementById('myLink').href = "creampants.php";
		}
		var checked_color = document.querySelector('input[name = "color"]:checked');
