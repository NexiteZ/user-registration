    ...
    <!-- Page Header End -->
	 <main class="container">
      ...
      <div class="left-column">
        <img data-image="white" class="active" src="img/bd1.jpg" alt="">
        <img data-image="brown" src="bd2.jpg" alt="">
        <img data-image="bluebd" src="bd3.jpg" alt="">
      </div>
        ...
        <div class="product-configuration">
          ...
          <div class="product-color">
            ...
            <div class="color-choose">
              ...
              <div>
                <input data-image="bluebd" type="radio" id="bluebd" name="color" value="bluebd">
                <label for="bluebd"><span></span></label>
              </div>
            </div>
...
<script>
    function myFunction() {
        ...
        if(document.getElementById('white').checked) {
            document.getElementById('myLink').href = "backless-white.php";
        }
		if(document.getElementById('brown').checked) {
            document.getElementById('myLink').href = "backless-brown.php";
        }
		if(document.getElementById('bluebd').checked) {
            document.getElementById('myLink').href = "backless-bluebd.php";
		}
