...
<header class="header">
   ...
   <div class="flex">
      ...
      <nav class="navbar">
         <a href="shop.php">add products</a>
         <a href="cart10.php">view products</a>
      </nav>
      ...
      <a href="cart10.php" class="cart">cart <span><?php echo $row_count; ?></span> </a>
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" placeholder="e.x. flat no." name="flat" required>
         </div>
         <div class="inputBox">
            <span>address line 2</span>
            <input type="text" placeholder="e.x. street name" name="street" required>
         </div>
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="e.x. batangas" name="city" required>
         </div>
         <div class="inputBox">
            <span>state</span>
            <input type="text" placeholder="e.x. manila" name="state" required>
         </div>
         <div class="inputBox">
            <span>country</span>
            <input type="text" placeholder="e.x. philippines" name="country" required>
         </div>
         <div class="inputBox">
            <span>pin code</span>
            <input type="text" placeholder="e.x. 123456" name="pin_code" required>
         </div>
      </div>
