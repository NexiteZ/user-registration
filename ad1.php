    ...
    <!-- Page Header End -->
	 <main class="container">
      ...
      <div class="left-column">
        <img data-image="black" src="ad1.jpg" alt="">
        <img data-image="blue" src="ad2.jpg" alt="">
        <img data-image="red" class="active" src="ad3.jpg" alt="">
      </div>
        ...
        <div class="product-configuration">
          ...
          <div class="product-color">
            ...
            <div class="color-choose">
              <div>
                <input data-image="red" type="radio" id="red" name="color" value="red" class="cart-btn">
                <label for="red"><span></span></label>
              </div>
              <div>
                <input data-image="blue" type="radio" id="blue" name="color" value="bluebutton" class="cart-btn">
                <label for="blue"><span></span></label>
              </div>
              <div>
                <input data-image="black" type="radio" id="black" name="color" value="blackbutton" class="cart-btn">
...
<script>
    function myFunction() {
        ...
        if(document.getElementById('red').checked) {
            document.getElementById('myLink').href = "athena-pink.php";
        }
		if(document.getElementById('blue').checked) {
            document.getElementById('myLink').href = "athena-green.php";
        }
		if(document.getElementById('black').checked) {
            document.getElementById('myLink').href = "athena-darkblue.php";
		}
